...
# Module 3.5.5 Determine the winning candidate (I)/(IV)
...
# Module 3.6.1 (A) : Save the results to our text file.
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        ...
        #x3.6.1. Will instead write the results to a text file.
        #   # ' (iv) Print the candidate name and percentage of votes.
        #   print(f"{candidate_name}:  {vote_percentage:.1f}% ({votes:,})\n")
        #-x3.6.1.

        # Module 3.6.2 : Write the candidates' results to a text file
        candidate_results = (
        ...
        # Module 3.5.5 Determine the winning candidate (II)/(IV)
    ...
    # Module 3.5.5 Determine the winning candidate (III)/(IV)
    ...
    #
    # Module 3.5.5 Determine the winning candidate (IV)/(IV)
