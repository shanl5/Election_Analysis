...
highest_turnout_county_percentage = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        if (county_votes > highest_turnout_county_votes) and (county_vote_percentage > highest_turnout_county_percentage):
            highest_turnout_county_votes = county_votes
            highest_turnout_county_name = county_name
            highest_turnout_county_percentage = county_vote_percentage

    # 7: Print the county with the largest turnout to the terminal.
    highest_turnout_county_summary = (
        f"\n-------------------------"
        f"\nLargest County Turnout: {highest_turnout_county_name}"
        f"\n-------------------------\n")
